...
#include "Fl_My_Native_File_Chooser_common.cxx"
#include "Fl_My_Native_File_Chooser_GTK.cxx"

#include <sys/stat.h>
#include <string.h>

int Fl_My_Native_File_Chooser::have_looked_for_GTK_libs = 0;
 ...
 */
Fl_My_Native_File_Chooser::Fl_My_Native_File_Chooser(int val)
{
    ...
    if (Fl_GTK_File_Chooser::did_find_GTK_libs) {
        _gtk_file_chooser = new Fl_GTK_File_Chooser(val);
    }
    else {
 ...
 */
Fl_My_Native_File_Chooser::~Fl_My_Native_File_Chooser()
{
    delete _x11_file_chooser;
}

/**
 Sets the current Fl_My_Native_File_Chooser::Type of browser.
 */
void Fl_My_Native_File_Chooser::type(int t)
{
    return _x11_file_chooser->type(t);
}

/**
 Gets the current Fl_My_Native_File_Chooser::Type of browser.
 */
int Fl_My_Native_File_Chooser::type() const
{
    return _x11_file_chooser->type();
}

/**
 Sets the platform specific chooser options to \p val.
 \p val is expected to be one or more Fl_My_Native_File_Chooser::Option flags ORed together.
...
\endcode
 */
void Fl_My_Native_File_Chooser::options(int o)
{
    _x11_file_chooser->options(o);
}

/**
 Gets the platform specific Fl_My_Native_File_Chooser::Option flags.
 */
int Fl_My_Native_File_Chooser::options() const
{
    return _x11_file_chooser->options();
}
...
/**
 ...
 \endcode
 */
int Fl_My_Native_File_Chooser::count() const
{
    return _x11_file_chooser->count();
}
 ...
 */
const char *Fl_My_Native_File_Chooser::filename() const
{
    return _x11_file_chooser->filename();
}
...
/**
 ...
 \endcode
 */
const char *Fl_My_Native_File_Chooser::filename(int i) const
{
    return _x11_file_chooser->filename(i);
}
 ...
 */
void Fl_My_Native_File_Chooser::directory(const char *val)
{
    _x11_file_chooser->directory(val);
}

/**
 Returns the current preset directory() value.
 */
const char *Fl_My_Native_File_Chooser::directory() const
{
    return _x11_file_chooser->directory();
}
 ...
 */
void Fl_My_Native_File_Chooser::title(const char *t)
{
    _x11_file_chooser->title(t);
}
 ...
 */
const char *Fl_My_Native_File_Chooser::title() const
{
    return _x11_file_chooser->title();
}
 ...
 */
const char *Fl_My_Native_File_Chooser::filter() const
{
    return _x11_file_chooser->filter();
}
 ...
 */
void Fl_My_Native_File_Chooser::filter(const char *f)
{
    _x11_file_chooser->filter(f);
}

/**
 Gets how many filters were available, not including "All Files"
 */
int Fl_My_Native_File_Chooser::filters() const
{
    return _x11_file_chooser->filters();
}
 ...
 */
void Fl_My_Native_File_Chooser::filter_value(int i)
{
    _x11_file_chooser->filter_value(i);
}
 ...
 */
int Fl_My_Native_File_Chooser::filter_value() const
{
    return _x11_file_chooser->filter_value();
}
 ...
 */
void Fl_My_Native_File_Chooser::preset_file(const char *f)
{
    _x11_file_chooser->preset_file(f);
}

/**
 Get the preset filename.
 */
const char *Fl_My_Native_File_Chooser::preset_file() const
{
    return _x11_file_chooser->preset_file();
}
 ...
 */
const char *Fl_My_Native_File_Chooser::errmsg() const
{
    return _x11_file_chooser->errmsg();
}
 ...
 */
int Fl_My_Native_File_Chooser::show()
{
    return _x11_file_chooser->show();
}
...
{
    switch (val) {
    case Fl_My_Native_File_Chooser::BROWSE_FILE:
        return (Fl_File_Chooser::SINGLE);
    case Fl_My_Native_File_Chooser::BROWSE_DIRECTORY:
        return (Fl_File_Chooser::SINGLE | Fl_File_Chooser::DIRECTORY);
    case Fl_My_Native_File_Chooser::BROWSE_MULTI_FILE:
        return (Fl_File_Chooser::MULTI);
    case Fl_My_Native_File_Chooser::BROWSE_MULTI_DIRECTORY:
        return (Fl_File_Chooser::DIRECTORY | Fl_File_Chooser::MULTI);
    case Fl_My_Native_File_Chooser::BROWSE_SAVE_FILE:
        return (Fl_File_Chooser::SINGLE | Fl_File_Chooser::CREATE);
    case Fl_My_Native_File_Chooser::BROWSE_SAVE_DIRECTORY:
...
int Fl_FLTK_File_Chooser::show()
{
    ...
    // OPTIONS: PREVIEW
    _file_chooser->preview((options() & Fl_My_Native_File_Chooser::PREVIEW) ? 1 : 0);

    // OPTIONS: NEW FOLDER
    if (options() & Fl_My_Native_File_Chooser::NEW_FOLDER) {
    ...
    if (_file_chooser->value() && _file_chooser->value()[0]) {
        ...
        if (options() & Fl_My_Native_File_Chooser::SAVEAS_CONFIRM && type() == Fl_My_Native_File_Chooser::BROWSE_SAVE_FILE) {
            struct stat buf;
...
{
    return fl_choice("%s", fl_cancel, fl_ok, NULL, Fl_My_Native_File_Chooser::file_exists_message);
}
